...
Unprepared   (3): Magic Circle, Major Image, Intellect Fortress, Glyph of Warding, Sending, Tiny Servant \
...
1st (2+1 Prepared): *Silvery Barbs*, Shield \
2nd (4+1 Prepared): Mirror Image, Gentle Repose, *Immovable Object*, Vortex Warp \
3rd (6 Prepared): Haste, Pulse Wave, Slow, Wall of Water, Remove Curse \
4th (3 Prepared): Summon Warrior Spirit (UA), Psychic Lance, Banishment \
...
**Arcane Mastery:** \
You can cast *Silvery Barbs* and *Immovable Object* without needing to expend a spell slot. You can change one of these spells over the course of a long rest. 
